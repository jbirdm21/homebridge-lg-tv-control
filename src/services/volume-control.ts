...
export class VolumeControlService {
  ...
  private readonly DEFAULT_MIN_STEP = 1;
  private readonly VOLUME_POLLING_INTERVAL = 10000; // 10 seconds
  private volumePollingInterval?: NodeJS.Timeout;
